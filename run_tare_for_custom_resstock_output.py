...
if __name__ == "__main__":
    ...
    sensitivity_case_name = args.sensitivity_case_name
    ...
    for region in ["national_ASHP"]:
        ...
        data_folder_file_path = os.path.join("/home", "arnavgautam","resstock-3.4.0",f"{region}_{NUM_RESIDENCES}_{unit_num}_unit_residence_ASHPautosized")
        print(data_folder_file_path)
