...
df['clothesDrying_replace_metric2'] = 2.7  # Wrong for gas!

# AFTER - Correct by fuel type
df['clothesDrying_replace_metric2'] = 2.7  # Electric: CEF = 2.7
gas_mask = df['base_clothesDrying_fuel'].isin(['Natural Gas', 'Propane'])
df.loc[gas_mask, 'clothesDrying_replace_metric2'] = 2.39  # Gas: CEF = 2.39
```
...
df['clothesDrying_replace_metric1'] = np.nan  # Placeholder
...
df['clothesDrying_replace_metric1'] = (pm1_lower + pm1_upper) / 2.0  # REMDB-driven
```
