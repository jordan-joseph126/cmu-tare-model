            ...
            for mer_type in MER_TYPES:
                ...
                for scc_assumption in SCC_ASSUMPTIONS:
                    ...
                    if menu_mp != 0 and df_baseline_damages is not None:
                        ...
                        # Check if baseline column exists before calculating avoided damages
                        if baseline_damages_col in df_baseline_damages.columns:
                            lifetime_dict[avoided_damages_col] = df_baseline_damages[baseline_damages_col] - lifetime_dict[damages_col]
                        else:
                            print(f"Warning: Column '{baseline_damages_col}' not found in baseline data. Setting avoided damages to 0.")
                            lifetime_dict[avoided_damages_col] = 0  # Or another appropriate default value
