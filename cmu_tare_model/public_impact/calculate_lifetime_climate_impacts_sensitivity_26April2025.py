...
def calculate_lifetime_climate_impacts(
        ...
        try:
            ...
            for year in range(1, lifetime + 1):
                ...
                try:
                    ...
                    # =======================================================================================
                    # UPDATED: Use the new validation approach to update emissions/damages for retrofits
                    # Store annual emissions in lists instead of updating incrementally
                    for mer_type in MER_TYPES:
                    ...
                    # Store annual damages in lists instead of updating incrementally
    ...
    df_main = apply_final_masking(df_main, all_columns_to_mask, verbose=verbose)
