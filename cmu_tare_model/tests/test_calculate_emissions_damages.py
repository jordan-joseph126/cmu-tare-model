...
from cmu_tare_model.public_impact.create_lookup_climate_damages_electricity import (
    lookup_co2e_emis_electricity_preIRA as dummy_co2e_preIRA,
    lookup_co2e_emis_electricity_IRA as dummy_co2e_IRA
)
...
def mock_lookup_co2e_emis_electricity_preIRA():
    ...
    return {
        ('MidCase', 'R1'): {
            2024: {'lrmer_ton_per_kWh_co2e': 0.0005, 'srmer_ton_per_kWh_co2e': 0.0007},
            2025: {'lrmer_ton_per_kWh_co2e': 0.0004, 'srmer_ton_per_kWh_co2e': 0.0006},
        }
    }
...
def mock_lookup_co2e_emis_electricity_IRA():
    ...
    return {
        ('MidCase', 'R1'): {
            2024: {'lrmer_ton_per_kWh_co2e': 0.0003, 'srmer_ton_per_kWh_co2e': 0.0005},
            2025: {'lrmer_ton_per_kWh_co2e': 0.0002, 'srmer_ton_per_kWh_co2e': 0.0004},
        }
    }
...
def sample_baseline_damages():
    ...
    """
    data = {
        'baseline_heating_lifetime_tons_co2e_lrmer': [50.0, 60.0],
        'baseline_heating_lifetime_damages_climate_lrmer': [100.0, 120.0],
        'baseline_heating_lifetime_tons_co2e_srmer': [70.0, 80.0],
...
def test_climate_emissions_and_damages_preIRA(sample_df, mock_lookup_co2e_emis_electricity_preIRA):
    ...
    # e.g., 'preIRA_mp1_2024_heating_tons_co2e_lrmer'
    expected_cols = [
...
def test_calculate_marginal_damages_valid(sample_df, sample_baseline_damages):
    ...
    expected_col_substring = 'preIRA_mp1_heating_lifetime_tons_co2e_lrmer'
