...
if TRANE_ANALYSIS == True:
    ...
    EQUIPMENT_SPECS = {'heating': 15, 'cooling': 15}
    ...
    REBATE_MAPPING = {
        # Be sure to update code logic so that the rebate is only applied once (i.e., $8000 total, not $8000 per equipment if both heating and cooling are upgraded)
