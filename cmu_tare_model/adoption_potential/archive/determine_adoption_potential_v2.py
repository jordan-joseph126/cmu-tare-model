...
def adoption_decision(df, menu_mp, policy_scenario, include_health_benefits, health_damages_method):
    ...
    for category, upgrade_column in upgrade_columns.items():
        ...
        for mer_type in ['lrmer', 'srmer']:
            ...
            avoided_mt_co2e_col = f'{scenario_prefix}{category}_avoided_mt_co2e_{mer_type}'
            ...
            for col in [lessWTP_private_npv_col, moreWTP_private_npv_col, public_npv_col, rebate_col, avoided_mt_co2e_col]:
