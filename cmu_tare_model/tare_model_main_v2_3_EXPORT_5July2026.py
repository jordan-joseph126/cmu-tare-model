...
# %% [markdown]
# ## [TO-DO] UPDATE THE SIMPLIFIED DOTPLOT CODE FROM THE ADOPTION KPIS 
...
# %%
# PLACEHOLDER: UPDATE THE IMPORTS AND PLACEHOLDER TEXT BELOW
if GRID_IMPACT_ANALYSIS:

    # from cmu_tare_model.____ import ____
    ...
    if VERBOSE:
        ...
        OBJECTIVE 1
        --------------------------------------------------------
        ___.py file contains the documentation for the ___ function.
...
# %%
# UPDATE THE EXAMPLE CODE BELOW FOR THE NEW VISUALS AND COLUMN NAMES. 
# The following is an example of how to visualize the impact of climate benefits on retrofit adoption potential
