...
df_mp10_scenario_fuelCosts = df_mp10_scenario_consumption.copy()
...
print("\n", "Modeling Scenario: No Inflation Reduction Act")
df_mp10_scenario_fuelCosts = calculate_annual_fuelCost(df=df_mp10_scenario_fuelCosts, menu_mp=menu_mp, policy_scenario='No Inflation Reduction Act', drop_fuel_cost_columns=False)

print("\n","Modeling Scenario: AEO2023 Reference Case")
df_mp10_scenario_fuelCosts = calculate_annual_fuelCost(df=df_mp10_scenario_fuelCosts, menu_mp=menu_mp, policy_scenario='AEO2023 Reference Case', drop_fuel_cost_columns=False)
...
DATAFRAME FOR MP10 Fuel Costs: df_mp10_scenario_fuelCosts
{df_mp10_scenario_fuelCosts}
      ====================================================================================================================================================================
""")
...
df_euss_am_mp10_home['rsMeans_CCI_avg'] = df_euss_am_mp10_home['city'].apply(map_average_cost)
df_euss_am_mp10_home
...
df_euss_am_mp10_home = calculate_private_NPV(df=df_euss_am_mp10_home,
                                            df_fuelCosts=df_mp10_scenario_fuelCosts,
                                            menu_mp=menu_mp,
                                            input_mp=input_mp,
                                            policy_scenario='No Inflation Reduction Act',
                                            interest_rate=0.07,
