...
# Project Future Energy Consumption
df_euss_am_mp9_home, df_mp9_scenario_consumption = project_future_consumption(df=df_euss_am_mp9_home,
...
DATAFRAME (Summary of MP9): df_euss_am_mp9_home

{df_euss_am_mp9_home}

DATAFRAME (Consumption Cols): df_mp9_scenario_consumption
      
{df_mp9_scenario_consumption}
""")

# %% [markdown]
# # Model Future Energy Climate Damages and Annual Fuel Costs
...
df_euss_am_mp9_home, df_mp9_scenario_damages = calculate_marginal_damages(df=df_euss_am_mp9_home, menu_mp=menu_mp, policy_scenario='AEO2023 Reference Case', df_baseline_damages=df_baseline_scenario_damages, df_detailed_damages=df_mp9_scenario_damages)
...
DATAFRAME FOR MP9 SCENARIO DAMAGES: df_mp9_scenario_damages
{df_mp9_scenario_damages}
...
print(f"""  
====================================================================================================================================================================
Post-Retrofit (MP9) Fuel Costs: WHOLE-HOME
Scenario: No Inflation Reduction Act and AEO2023 Reference Case
====================================================================================================================================================================
...
# %% [markdown]
# ### Space Heating with Basic Enclosure Upgrade (MP8 + MP1)
...
df_euss_am_mp9_home = calculate_enclosure_retrofit_upgradeCosts(df=df_euss_am_mp9_home,
...
Scenario: No Inflation Reduction Act and AEO2023 Reference Case
====================================================================================================================================================================
Measure Package 9 (MP9) contains the Basic Enclosure Upgrade (MP1). 
...
DATAFRAME WITH MP9 ENCLOSURE COSTS: df_euss_am_mp9_home
...
# %% [markdown]
# # SCENARIO ANALYSIS: Moderate Pre-IRA Scenario
...
df_euss_am_mp9_home = calculate_public_npv(df=df_euss_am_mp9_home,
                                           ...
                                           df_mp_damages=df_mp9_scenario_damages,
                                           menu_mp=menu_mp,
...
DATAFRAME FOR MP9 AFTER CALCULATING PUBLIC NPV: df_euss_am_mp9_home
...
DATAFRAME FOR MP9 AFTER CALCULATING PRIVATE NPV: df_euss_am_mp9_home
...
DATAFRAME FOR MP9 AFTER DETERMINING ADOPTION FEASIBILITY: df_euss_am_mp9_home
